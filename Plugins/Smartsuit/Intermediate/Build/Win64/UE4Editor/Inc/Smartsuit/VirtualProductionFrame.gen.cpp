...
static struct FScriptStruct_Smartsuit_StaticRegisterNativesFFace
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFace_Statics::NewProp_actorName_MetaData[] = {
		{ "Category", "Virtual Production" },
		{ "ModuleRelativePath", "Public/VirtualProductionFrame.h" },
		{ "ToolTip", "Face's ID." },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FFace_Statics::NewProp_actorName = { "actorName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFace, actorName), METADATA_PARAMS(Z_Construct_UScriptStruct_FFace_Statics::NewProp_actorName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFace_Statics::NewProp_actorName_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FFace_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFace_Statics::NewProp_actorName,
	...
	uint32 Get_Z_Construct_UScriptStruct_FFace_Hash() { return 1433120936U; }
